...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link type="text/css" href="<c:url value="/resources/static/css/bootstrap.min.css"/>"  rel="stylesheet">
    <!-- Custom styles for this template -->
    <link type="text/css" href="<c:url value="/resources/static/css/signin.css"/>" rel="stylesheet">
</head>
